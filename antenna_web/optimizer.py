...
# Imports from simulator (assumes sys.path is set by app.py)
...
from visualization.smith_chart import calculate_impedance_from_fdtd, ImpedanceResult
...
class AntennaOptimizer:
    ...
    def optimize_length(self, 
        ...
        for i in range(max_iter):
            ...
            try:
                ...
                res_data = result.find_resonance(freq_min=target_freq*0.5, freq_max=target_freq*1.5)
    ...
    def _run_simulation(self, type: str, length: float, radius: float, freq: float) -> ImpedanceResult:
