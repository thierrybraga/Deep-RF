...
from fem.solver import FEMSolver2D
from fem.solver_3d import FEMSolver3D
from fem.mesh_generator import MeshGenerator
import os
    ...
    try:
        ...
        results = {
            ...
            'stats': {
                ...
                'impedance': {'real': float(np.real(Z)), 'imag': float(np.imag(Z)), 'magnitude': float(np.abs(Z))}
            },
