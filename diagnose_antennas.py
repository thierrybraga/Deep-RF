...
from antenna_simulator.core.geometry.primitives import Wire, Rectangle, Helix, Horn, ParabolicDish

def diagnose_antennas():
    factories = [
        ...
        ('Horn', lambda: AntennaFactory.create_horn(10e9, aperture_width=0.05, aperture_height=0.04, length=0.1)),
