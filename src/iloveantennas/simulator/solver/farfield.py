...
from iloveantennas.simulator.core.grid import GridConfig
...
class NearToFarField:
    ...
    def __init__(self, nf_box: NearFieldBox, grid_config: GridConfig, frequency: float):
        """
        Args:
    ...
    def calculate_far_field(
        ...
        r_hat = np.stack([sin_theta * cos_phi, sin_theta * sin_phi, cos_theta], axis=-1)
